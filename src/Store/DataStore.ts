...
class DataStore {
    ...
    constructor() {
        this._rows = [
            ...
            {id: 9, title: "Фундаментальные работы", unit: "", quantity: 0, unitPrice: 0, price: 0, parent: 4, type: "level"},
            {id: 10, title: "Статья работы №1", unit: "м3", quantity: 1750, unitPrice: 108.07, price: 0, parent: 9, type: "row"},
            {id: 11, title: "Статья работы №2", unit: "л", quantity: 1200, unitPrice: 850, price: 0, parent: 9, type: "row"},
            {id: 12, title: "Статья работы №3", unit: "л", quantity: 1200, unitPrice: 850, price: 0, parent: 9, type: "row"},
            {id: 13, title: "Статья работы №3", unit: "л", quantity: 1200, unitPrice: 850, price: 0, parent: 9, type: "row"},
        ]
